import type { Attribute, Common, Utils, Entity } from "@strapi/strapi";

export type NonFilterableKind = Extract<
  Attribute.Kind,
  "password" | "dynamiczone"
>;
export type FilterableKind = Exclude<Attribute.Kind, NonFilterableKind>;
export type GetNonFilterableKeys<TSchemaUID extends Common.UID.Schema> =
  Utils.Object.KeysBy<
...
>;
export type OmitRelationWithoutTarget<
    ...
    Utils.Expression.MatchFirst<
      [
        ...
        [
          ...
          TAttribute extends Attribute.Component<
            infer TComponentUID,
            infer TRepeatable
          >
            ? TComponentUID extends Common.UID.Component
        ...
        [
          Utils.Expression.Extends<
            TAttribute,
            Attribute.Timestamp | Attribute.DateTime
          >,
          DateTimeValue,
        ],
